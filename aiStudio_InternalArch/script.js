document.addEventListener('DOMContentLoaded', function() {
    ...
    const overviewComponents = [
        ...
        },
        {
            id: 'storage',
            title: 'Storage VM',
            x: 300, y: 250, width: 180, height: 80,
            layer: 2,
            ...
            connections: [],
            subComponents: ['mongodb', 'qdrantdb', 'postgresql']
        },
        {
            id: 'embedding',
            title: 'Embedding Cluster',
            x: 600, y: 250, width: 180, height: 80,
            layer: 2,
            ...
            connections: ['storage'],
            subComponents: ['paddleocr', 'docling', 'llamaparse']
        },
        {
            id: 'execution',
            title: 'Mind Execution Cluster',
            x: 900, y: 250, width: 180, height: 80,
            layer: 2,
        ...
        },
        {
            ...
            x: 900, y: 400, width: 180, height: 80,
            layer: 3,
        ...
        },
        {
            id: 'lightningrag',
            title: 'L⚡RAG',
            x: 300, y: 400, width: 180, height: 80,
            layer: 3,
            description: `<p>Lightning RAG (L⚡RAG) is an advanced Retrieval Augmented Generation platform:</p>
                <ul>
                ...
                <p>L⚡RAG forms the knowledge foundation of the AI/Studio system, transforming raw data into queryable information.</p>`,
            connections: ['storage', 'embedding'],
            subComponents: []
        },
        {
            id: 'platform-layer',
            title: 'Platform Services',
            x: 250, y: 550, width: 700, height: 100,
            layer: 4,
            isGroup: true,
        ...
        },
        {
            id: 'quantumminds',
            title: 'Quantum Minds',
            x: 300, y: 560, width: 180, height: 80,
            layer: 4,
            ...
            connections: ['lightningrag', 'execution'],
            subComponents: []
        },
        {
            id: 'mcp',
            title: 'MCP Streams',
            x: 510, y: 560, width: 180, height: 80,
            layer: 4,
            parentGroup: 'platform-layer',
            ...
            connections: ['scheduler', 'storage'],
            subComponents: []
        },
        {
            id: 'operators',
            title: 'Agentic Operators',
            x: 720, y: 560, width: 180, height: 80,
            layer: 4,
            parentGroup: 'platform-layer',
            ...
            connections: ['execution', 'quantumminds'],
            subComponents: []
        }
    ];
